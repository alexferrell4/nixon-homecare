...
const additionalServices = [
  ...
  },
  {
    ...
    description:
      "We are actively seeking volunteers. Make sure to send us a message below if you are interested in making a difference. Please message us in order to volunteer with us.",
  },
  {
    icon: HandHeart,
    title: "Donate to Nixon Home Care",
    description:
      "If you would like to make a contribution to our non-profit organization simply email us or contact us through the form below.",
  },
];
          ...
          {additionalServices.map((service, index) => (
            ...
            >
              ...
              {service.title === "Donate to Nixon Home Care" && (
                <div className="mt-6">
                  <a
                    href="https://givebutter.com/nixonhomecare"
                    target="_blank"
